...
function updateExportButton(hasIncompleteTests, incompleteTestsInfo) {
    ...
    if (exportButton) {
        // Check if we have any analysis results loaded (from current analysis or history)
        ...
        if (hasAnalysisResults) {
            // If we have analysis results, enable export regardless of channel completion
            // Users can export partial results for their own analysis
